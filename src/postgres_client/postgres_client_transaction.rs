...
impl SimplePostgresClient {
    pub(crate) fn build_transaction_info_upsert_statement(
        ...
        let stmt = "INSERT INTO transaction AS txn (signature, index, is_vote, slot, message_type, \
        legacy_message, v0_loaded_message, signatures, message_hash, meta, write_version, updated_on) \
